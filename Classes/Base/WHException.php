	...
	*/
	...
	public function pretyException(){
		...
		$return .= "<h2> Uncaught Exception: ".
				$this->message.
				" in ".
					static::textMateLink($this->file,$this->line).
				"</h2>";
    ...
    public static function textMateLink($file,$line){
		$url = "txmt://open?url=file://$file&line=".$line ;
		$url = "<a href='$url'>In file ".$file. " line ".$line."</a>";
	...
	public static function niceFromTracePoint($point,$highlight){
		$url = static::textMateLink($point['file'],$point['line']);
